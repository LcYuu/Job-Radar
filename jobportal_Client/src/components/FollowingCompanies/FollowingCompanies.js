...
const companies = [
  { id: 1, name: 'FPT', logo: logo },
  { id: 2, name: 'Google', logo: logo },
  { id: 3, name: 'Microsoft', logo: logo },
  { id: 4, name: 'DigitalOcean', logo: logo },
  { id: 5, name: 'Amazon', logo: logo },
  { id: 6, name: 'Unilever', logo: logo },
  { id: 7, name: 'Facebook', logo: logo },
  { id: 8, name: 'Tesla', logo: logo },
  { id: 9, name: 'Tesla', logo: logo },
  { id: 10, name: 'Tesla', logo: logo },
  { id: 11, name: 'Tesla', logo: logo },
  { id: 12, name: 'Tesla', logo: logo },
  { id: 13, name: 'Tesla', logo: logo },
  { id: 14, name: 'Tesla', logo: logo },
  { id: 15, name: 'Tesla', logo: logo },
  { id: 16, name: 'Tesla', logo: logo },
